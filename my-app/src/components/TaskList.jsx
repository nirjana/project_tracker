...
const TaskList = ({ project, onBack, onAddTask, onUpdateStatus }) => {
  ...
  const [modalTitle, setModalTitle] = useState(""); // Store the title for the modal

  // Function to handle title click and show the modal
  const handleTitleClick = () => {
    setModalTitle(project.title); // Set the title to show in the modal
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            {/* Display entire title with word wrapping */}
